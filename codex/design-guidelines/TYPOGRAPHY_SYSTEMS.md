...
- Skilled readers recognize words through parallel letter-feature processing, not letters serially — so ALL-CAPS body text (uniform rectangles) slows reading ~10–20%; reserve caps for ≤3-word labels with tracking. [E]
