...
- **Outfit** — Feel: clean modern geometric with full 100–900 variable range; Futura's logic, today's proportions · Pair: Literata, Fragment Mono · Use: brand headers, marketing pages, logo-adjacent type · + polished geometry across all weights − single-story geometry tires eyes in longform · A11y: keep body use ≥16px, moderate line length · Overlooked: crowded geometric category hides it · License: OFL. Source: https://fonts.google.com/specimen/Outfit [E]
