...
Router for `claude/design-guidelines/`. Exempt from per-doc validation (see `CONVENTIONS.md`); the doc table below is the single source cross-refs resolve against.
