...
- Started-but-unfinished tasks create completion pressure (Zeigarnik effect), and perceived progress accelerates effort as the goal nears (goal-gradient: Kivetz et al. 2006, reward-card completion sped up near the end and pre-stamped cards nearly doubled completion, 34% vs 19%). Progress you *give* the user is fuel. [E]
...
- Use an onboarding checklist of 3–5 concrete tasks with one item pre-completed ("account created ✓") — endowed progress (Kivetz) plus Zeigarnik tension measurably lifts completion versus an empty list. Show percent or fraction complete. [E]
